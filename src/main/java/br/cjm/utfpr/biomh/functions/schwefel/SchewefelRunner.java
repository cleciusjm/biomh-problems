...
public class SchewefelRunner implements Callable<List<FunctionsFinalSolution>> {
	private static final int AGENTS = 500;
	private static final int ITERATIONS = 300;
	private static final double UPPER_BOUND = 500.0;
	private static final double LOWER_BOUND = -500.0;
	...
	public List<FunctionsFinalSolution> call() {
		...
		results.add(run(new GeneticAlgorithm(new SchwefelFitnessFunction(), ITERATIONS, AGENTS, ENTITY_LENGTH, UPPER_BOUND, LOWER_BOUND)));
		results.add(run(new ClonalgAlgorithm(new SchwefelFitnessFunction(), ITERATIONS, AGENTS, ENTITY_LENGTH, UPPER_BOUND, LOWER_BOUND)));
		results.add(run(new OptAiNetAlgorithm(new SchwefelFitnessFunction(), ITERATIONS, AGENTS, ENTITY_LENGTH, UPPER_BOUND, LOWER_BOUND)));
		results.add(run(new PSOAlgorithm(new SchwefelFitnessFunction(), ITERATIONS, AGENTS, ENTITY_LENGTH, UPPER_BOUND, LOWER_BOUND)));
		return results;
	}
